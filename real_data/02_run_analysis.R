...
nuisance_output <- readRDS(file = paste0("/projects/dbenkes/allison/drotr_sim/journal/results_real_data/nuisance/nuisance_seed_", seed, ".Rds"))
...
#saveRDS(nuisance_output, file = paste0("/projects/dbenkes/allison/drotr_sim/journal/results_real_data/nuisance/nuisance_seed_", seed, ".Rds"))
...
saveRDS(results_gold_standard$results, file = paste0("/projects/dbenkes/allison/drotr_sim/journal/results_real_data/results/gold_standard/results_gs_seed_", seed, ".Rds"))
...
saveRDS(results_host$results, file = paste0("/projects/dbenkes/allison/drotr_sim/journal/results_real_data/results/host/results_host_seed_", seed, ".Rds"))
