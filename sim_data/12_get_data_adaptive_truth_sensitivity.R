...
if(sens_type == "mcar"){
  abcd_data_sim <- generate_abcd(n, mcar_sens = TRUE, mcar_prop = 0.25)
} else{
  abcd_data_sim <- generate_abcd(n, mar_sens = TRUE)
}
...
results <- readRDS(paste0(dir, "/gold_standard/", sens_type, "_full_results_n_6692_seed_", seed, ".Rds"))
