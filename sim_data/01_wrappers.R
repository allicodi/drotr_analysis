...
here::i_am("sim_data/01_wrappers.R")
...
SL.cate.host <- function(Y, X, newX, family, ...){
  sl.cate.host_fit <- glm(Y ~ avemuac + wfazscore + lfazscore + wflzscore + site + 
...
SL.cate.host2 <- function(Y, X, newX, family, ...){
  sl.cate.host2_fit <- glm(Y ~ (avemuac + wfazscore + lfazscore + wflzscore + site + 
